...
//
//	// Right quad
//	midPoints[1] = QuadMidPoint(inputPatch[2].position, inputPatch[3].position, inputPatch[4].position, inputPatch[5].position);
//
//	// Front quad
//	midPoints[2] = QuadMidPoint(inputPatch[1].position, inputPatch[2].position, inputPatch[6].position, inputPatch[7].position);
//
//	// Left quad
//	midPoints[3] = QuadMidPoint(inputPatch[0].position, inputPatch[1].position, inputPatch[8].position, inputPatch[9].position);
//
//	// Back quad
//	midPoints[4] = QuadMidPoint(inputPatch[0].position, inputPatch[3].position, inputPatch[10].position, inputPatch[11].position);
//
//	return midPoints;
//}
...
float NormalizedDistanceFromCamera(float3 cameraPosition, float3 quadMidPoint)
{
	//float distanceBetween = distance(cameraPosition, quadMidPoint);
...
//	float levelsOfDetail[5];
//
//	levelsOfDetail[0] = QuadLevelOfDetail(midPoints[0]);
//
//	levelsOfDetail[1] = QuadLevelOfDetail(midPoints[1]);
//
//	levelsOfDetail[2] = QuadLevelOfDetail(midPoints[2]);
//
//	levelsOfDetail[3] = QuadLevelOfDetail(midPoints[3]);
//
//	levelsOfDetail[4] = QuadLevelOfDetail(midPoints[4]);
//
